...
#define ADD_TO_VALUE_MAP(level) \
    valueMap.insert(ValueMap::value_type(level.getValue(), level))

static NameMap nameMap;
#define ADD_TO_NAME_MAP(level) \
    nameMap.insert(NameMap::value_type(level.getName(), level))
